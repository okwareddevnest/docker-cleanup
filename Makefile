...
publish: build
	...
	@cd $(REPO_DIR) && gpg --batch --yes --armor --detach-sign -o dists/stable/Release.gpg dists/stable/Release
	@cd $(REPO_DIR) && gpg --batch --yes --clearsign -o dists/stable/InRelease dists/stable/Release
